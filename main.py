...
seed = 42
# Value between 0 - 1. This is the discount factor
gamma = 0.99
max_steps_pr_episode = 10000
...
# Set up agent critic network
num_inputs = 4
num_actions = 2
num_hidden_layers = 128

inputs = layers.Input(shape=(num_inputs,))
common = layers.Dense(num_hidden_layers, activation="relu")(inputs)
...
while True:
    ...
    with tf.GradientTape() as tape:
        for timestep in range(1, max_steps_pr_episode):
